...
let morningRoutineTime = brushTeeth + chooseClothes + goJogging + shower + calendarReview
 ...
 */
 // must do
let mustDo = morningRoutineTime

// would like to
let dogToDogPark = 20
let read = 30

let tryToDo = dogToDogPark + read
/*:
