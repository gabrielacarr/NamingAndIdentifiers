...
let totalNumberOfAnimals = numberOfDogs + numberOfCats + numberOfTurtles + numberOfHamsters + potBelliedPig + fish + snake

let totalNumberOfMammals = numberOfDogs + numberOfCats + numberOfHamsters + potBelliedPig

let numberOfNonMammals = numberOfTurtles + fish + snake 
/*:
